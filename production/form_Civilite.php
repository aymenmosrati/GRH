          ...
          <div class="row">
            <div class="col-md-12">
              <div class="x_panel">
                ...
                <form class="x_content" action="ajout_Civilite.php" methode="GET">
                  <br />
                  <div class="form-label-left input_mask">

                    <div class="col-md-6 col-sm-6  form-group has-feedback">
                      <input type="text" name="nom" class="form-control has-feedback-left" id="inputSuccess2" placeholder="Nom">
                      <span class="fa fa-user form-control-feedback left" aria-hidden="true"></span>
                    </div>

                    <div class="col-md-6 col-sm-6  form-group has-feedback">
                      <input type="text" name="Prenom" class="form-control" id="inputSuccess3" placeholder="Prénom">
                    ...
                    <div class="col-md-6 col-sm-6  form-group has-feedback">
                      <input type="tel" name="telephone" class="form-control" id="inputSuccess5" placeholder="Phone">
                    ...
                    <div class="form-group row" id="nomjeune" hidden>
                      ...
                      <div class="col-md-8 col-sm-8 ">
                        <input type="text" name="nomjeune" value="-----" class="form-control" placeholder="Nom de Jeune fille">
                      </div>
                    </div>
                    <div class="form-group row" id="nbr_enfant" hidden>
                      <label class="col-form-label col-md-3 col-sm-3">Nombre d'enfants</label>
                      <div class="col-md-8 col-sm-8 ">
                        <input type="number" name="nbr_enfant" class="form-control" placeholder="Nombre  d'enfant">
                      </div>
                    </div>
                    <div class="form-group row">
                      ...
                      <div class="col-md-8 col-sm-8 ">
                        <input type="text" name="date_naissance" class="date-picker form-control" placeholder="dd-mm-yyyy" required="required" type="text" onfocus="this.type='date'" onmouseover="this.type='date'" onclick="this.type='date'" onblur="this.type='text'" onmouseout="timeFunctionLong(this)">
                        <script>
                  ...
                  <div class="form-label-left input_mask">
                    ...
                    <div class="d-flex justify-content-around">
                      <div class="col-md-5 cd-flex justify-content-aroundol-sm-5  form-group has-feedback">
                        ...
                        <input type="date" name="date_debut" class="form-control has-feedback-left" id="inputDate">
                      </div>
                      <div class="col-md-5 col-sm-5  form-group has-feedback">
                        <label for="inputDate2">Date de Fin</label>
                        <input type="date" name="date_fin" class="form-control" id="inputDate2">
                      </div>
                    </div>
                    <div class="d-flex justify-content-around">
                      <div class="col-md-5 cd-flex justify-content-aroundol-sm-5  form-group has-feedback">
                        <label for="inputDate3">Date d'embauche</label>
                        <input type="date" name="date_embauche" class="form-control has-feedback-left" id="inputDate3">
                      </div>
                      <div class="col-md-5 col-sm-5  form-group has-feedback">
                        <label for="inputDate4">Date de départ</label>
                        <input type="date" name="date_depart" class="form-control" id="inputDate4">
                      </div>
                    </div>
                    <br>
                  ...
                  <div class="form-label-left input_mask">
                    <div class="form-group row">
                      ...
                      <div class="col-md-6 col-sm-6  form-group has-feedback">
                        <input type="text" name="Adresse" class="form-control" id="Ad" placeholder="... ... ...">
                      </div>
                    </div>
                    <div class="form-group row">
                      <label class="col-form-label col-md-3 col-sm-3" for="Cd">Code Postal</label>
                      <div class="col-md-6 col-sm-6  form-group has-feedback">
                        <input type="Number" name="Code_Postal" class="form-control" id="Cd" placeholder="0000">
                      </div>
                    </div>
                    <div class="form-group row">
                      <label class="col-form-label col-md-3 col-sm-3" for="RB">RIB de Banque</label>
                      <div class="col-md-6 col-sm-6  form-group has-feedback">
                        <input type="Number" name="RIB_Banque" class="form-control" id="RB" placeholder="0000 0000 0000 0000 0000" max="20">
                      </div>
                    </div>
                    <div class="d-flex justify-content-around">
                      <div class="col-md-5 cd-flex justify-content-aroundol-sm-5  form-group has-feedback">
                      ...
                      <div class="col-md-5 col-sm-5  form-group has-feedback">
                        ...
                        <input type="text" name="Nom_guiche" class="form-control" placeholder="......." id="inputDate4">
                      </div>
                    </div>
                  ...
                  <div class="form-label-left input_mask">
                    <div class="Salarie" >
                     <span onclick="activeMontanMensuelle()">
                      ...
                      <label for="S" class="fhp"> Salaire </label>
                      <input type="radio" id="S" name="type" value="Salarie" width="150px" onclick="activeMontanMensuelle()" checked>
                      <input type="Number" class="form-control" id="Mensuelle" name="Salarie"  placeholder="0.000" >
                     </span>
                    </div>
                    <br>
                    <!-- <div class="Horaire" >
