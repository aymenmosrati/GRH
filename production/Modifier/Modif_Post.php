            ...
            <div class="right_col" role="main">
                <div class="col-md-10 col-sm-10 ">
                    <div class="modal-header">
                        <h5 class="modal-title">Modifier la Post</h5>
                        <br><br><br>
                    </div>
                    <form action="Modif_Ajout/Modif_Ajout_Post.php" method="POST">
                        <div class="modal-body ">
                            <div class="item form-group">
                                <label class="col-form-label col-md-3 " for="id">ID</label>
                                <div class="col-md-7 col-sm-7">
                                    <input type="text" id="id" value="<?php echo $id ?>" class="form-control " disabled>
                            ...
                            <div class="item form-group">
                                ...
                                <div class="col-md-7 col-sm-7">
                                    <input type="text" id="Nom_Post" name="Nom_Post" value="<?php echo $stmt[1] ?>" class="form-control">
                                </div>
                            </div>
                        </div>
            ...
            <div class="modal-body">
                <div class="item form-group">
                    ...
                    <div class="col-md-8 col-sm-8 ">
                        <input type="text" id="id" value="" class="form-control " disabled>
