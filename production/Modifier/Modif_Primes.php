...
<div class="container body">
    <div class="main_container">
        ...
        <form action="Modif_Ajout/Modif_Ajout_Primes.php" method="POST">
            <div class="modal-body">
                ...
                <div class="item form-group">
                    ...
                    <div class="col-md-8 col-sm-8 ">
                        <input type="text" id="Nom_Primes" name="Nom_Primes" value="<?php echo $stmt[1] ?>" class="form-control">
                    </div>
                </div>
                <div class="item form-group">
                    <label class="col-form-label col-md-3 " for="Montant">Montant</label>
                    <div class="col-md-8 col-sm-8 ">
                        <input type="text" id="Montant" name="Montant_Primes" value="<?php echo $stmt[2] ?>" class="form-control">
                    </div>
                </div>
            </div>
        ...
        <form action="" method="POST">
            <div class="modal-body">
                ...
                <div class="item form-group">
                    <label class="col-form-label col-md-3 " for="Montant">Montant</label>
                    <div class="col-md-8 col-sm-8 ">
                        <input type="text" id="Montant" name="Montant" value="<?php echo $stmt[2] ?>" class="form-control">
                    </div>
                </div>
            </div>
            <div class="modal-footer">
