...
<body class="nav-md">
    <div class="container body">
        <div class="main_container">
            ...
            <form action="Modif_Ajout/Modif_Ajout_Villes.php" method="POST">
                <div class="modal-body">
                    ...
                    <div class="item form-group">
                        ...
                        <div class="col-md-8 col-sm-8 ">
                            <input type="text" id="Nom_Villes" name="Nom_Villes" value="<?php echo $stmt[1] ?>" class="form-control">
                        </div>
                    </div>
                </div>
