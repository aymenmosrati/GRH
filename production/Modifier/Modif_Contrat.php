           ...
           // include "../left_side_bar.php";
            ...
            <div class="right_col" role="main">
                ...
                <div class="modal-header">
                  <h5 class="modal-title">Modifier Ce Contrat</h5>
                </div>
          <form action="Modif_Ajout/Modif_Ajout_Contrat.php" method="POST">
            <div class="modal-body">
                ...
                <div class="item form-group">
                    ...
                    <div class="col-md-8 col-sm-8 ">
                        <input type="text" id="Nom_Contrat" name="Nom_Contrat" value="<?php echo $stmt[1] ?>" class="form-control">
                    </div>
                </div>
            </div>
