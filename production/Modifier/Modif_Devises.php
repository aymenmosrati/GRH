...
<body class="nav-md">
    <div class="container body">
        <div class="main_container">
            ...
            <h5 class="modal-title">Modifier Devise</h5>
        </div>
        <form action="Modif_Ajout/Modif_Ajout_Devises.php" method="POST">
            <div class="modal-body">
                ...
                <div class="item form-group">
                    ...
                    <div class="col-md-8 col-sm-8 ">
                        <input type="text" id="Nom_Devises" name="Nom_Devises" value="<?php echo $stmt[1] ?>" class="form-control">
                    </div>
                </div>
            </div>
