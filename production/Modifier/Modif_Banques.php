...
<body class="nav-md">
    <div class="container body">
        <div class="main_container">
            ...
            <h5 class="modal-title">Modifier Un Banque</h5>
            </div>
         <form action="Modif_Ajout/Modif_Ajout_Banques.php" method="POST">
            <div class="modal-body">
                ...
                <div class="item form-group">
                    ...
                    <div class="col-md-8 col-sm-8 ">
                        <input type="text" id="Nom_Banques" name="Nom_Banques" value="<?php echo $stmt[1] ?>" class="form-control">
                    </div>
                </div>
            </div>
